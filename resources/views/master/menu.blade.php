<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand text-center" href="{{url('/')}}">E-Office</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Văn bản">
                ...
                <ul class="sidenav-second-level collapse" id="listdocument">
                    
                    <li>
                        <a class="nav-link-collapse collapsed" data-toggle="collapse" href="#listdocument2">Văn bản đến</a>
                        <ul class="sidenav-third-level collapse" id="listdocument2">
                            <li>
